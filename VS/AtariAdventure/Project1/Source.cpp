...
public:
	...
	bool OnUserUpdate(float fElapsedTime) override
	{
		...
		case 1:
			//if (state) {
				...
				olc::PixelGameEngine::FillRect(240 - 10, 0, 20, 270, olc::YELLOW);
		...
		case 2:
			...
			olc::PixelGameEngine::FillRect(240 - 10, 0, 20, 270, olc::Pixel(0, 100, 100));
			olc::PixelGameEngine::FillRect(0, 0, 10, 270, olc::Pixel(0, 100, 100));
	...
	//	olc::PixelGameEngine::FillRect(x, y, 11, 11, olc::Pixel(0, 0, 0));
		...
		olc::PixelGameEngine::DrawRect(x, y, 10, 10);
		return true;
	}
};
